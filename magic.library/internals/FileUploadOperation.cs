...
{
    /*
     * Helper class to make sure Swagger can handle file upload endpoints.
     */
    internal sealed class FileUploadOperation : IOperationFilter
    {
        ...
        public void Apply(Operation operation, OperationFilterContext context)
        {
            ...
            foreach (var idxParam in operation.Parameters.ToArray())
            {
                ...
                if (formFileSubParameterNames.Any(p => idxParam.Name.StartsWith(p + ".", StringComparison.InvariantCulture)) ||
